...
- [Artifact-prefixed login routes](artifact-prefixed-login-routes.md) — preview URLs can include the artifact prefix even when Vite reports `/`; protect magic-link routes from the layout guard first
